...
def main(genomes, config):
    ...
    while run:
        ...
        for x, car in enumerate(cars):
            ...
            output = nets[x].activate((car.echo(0), car.echo(1), car.echo(2), car.echo(3), car.echo(4), car.Speed))
            ...
            car.colour = hsv_to_rgb((output[1]+4)/5, out0, 1)

            car.move(out0, out1, out2)
